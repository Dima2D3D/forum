...
<footer class="site-footer">
  <div class="footer-inner">
    <div class="footer-brand">
      <img src="<?=e(SITE_URL)?>/banners/IMG_20260727_215431_065.jpg" alt="GREFFRLEND" class="site-icon">
      <div><strong>GREFFRLEND</strong><span>Minecraft Community</span></div>
    </div>
    <nav class="footer-links">
      <a href="<?=e(SITE_URL)?>/rules.php">Правила сообщества</a>
      <a href="<?=e(SITE_URL)?>/offer.php">Оферта</a>
      <a href="<?=e(SITE_URL)?>/privacy.php">Конфиденциальность</a>
